...
-------
The most obvious problem currently comes when re-sizing the browser. The Price of the Products Jumps around in the Panel instead of moving smoothly. The Background images also overlap or split apart when the browser is resized. I beleive this because I have used px to position elements rather than %.
